            ...
            <div class="any-filter-container">
                <div class="sort-container">
                    <select name="sort" class="sort-select" onchange="updateSort(this.value)">
                        ...
                        <option value="price_asc" <?php echo $sort === 'price_asc' ? 'selected' : ''; ?>>Цена по
                            возрастанию</option>
                        <option value="price_desc" <?php echo $sort === 'price_desc' ? 'selected' : ''; ?>>Цена по
                            убыванию</option>
                        <option value="name_asc" <?php echo $sort === 'name_asc' ? 'selected' : ''; ?>>Название А-Я
                        </option>
                        <option value="name_desc" <?php echo $sort === 'name_desc' ? 'selected' : ''; ?>>Название Я-А
                        </option>
                    </select>
                </div>
                <div class="search-container">
                    <form class="search-box" method="GET" id="searchForm">
                        <input type="text" name="search" placeholder="Введите программу"
                    ...
                    <div class="program-type" id="program-type-<?php echo $type['id']; ?>">
                        <div class="program-type-header">
                            ...
                            <p class="type-description">
                                <?php echo $program_types[$type['id']]['description'] ?? htmlspecialchars($type['description']); ?>
                            </p>
                        </div>
