<script>
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        const inputs = {
            ...
            'second-password': document.querySelector("input[name='second-password']")
        };

        const errors = {
            first_name: document.getElementById("name-error"),
            last_name: document.getElementById("lastname-error"),
            email: document.getElementById("email-error"),
            'first-password': document.getElementById("password-error"),
            'second-password': document.getElementById("secondpassword-error"),
