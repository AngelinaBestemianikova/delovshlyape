            ...
            <div class="contact-grid">
                <div class="contact-info">
                    <div class="info-section">
                        ...
                        <p>Если у вас есть вопросы или вы хотите забронировать праздник, свяжитесь с нами по телефону
                            или электронной почте. Наши операторы будут рады ответить на ваши вопросы и помочь с
                            организацией торжества в любое удобное для вас время.
                        <p>
                            Работаем по Минску и в 20км от МКАД.
                        </p>
                        </p>
                    ...
                    <div class="info-section">
                        ...
                        <p>Вы также можете найти нас в социальных сетях и задать вопрос или оставить заявку через наши
                            официальные аккаунты. Мы всегда на связи и быстро реагируем на ваши сообщения.</p>
                ...
                <div class="contact-info">
                    <div class="info-section">
                        <h2>Как нас найти?</h2>
                        <p>Наш офис расположен в самом центре города по адресу: пр-т Победителей 39, Минск, Беларусь.
                            Рядом расположены две станции метро: "Немига" и "Молодежная".</p>

                        <div class="transport-info">
                            <div class="transport-section">
                                <h3>На машине:</h3>
                                <p>Если вы едете на личном автомобиле, вы можете воспользоваться платной парковкой,
                                    расположенной в 100 метрах от нашего офиса. Также рядом есть несколько бесплатных
                                    парковочных мест на прилегающих улицах.</p>
                            </div>

                            <div class="transport-section">
                                <h3>На общественном транспорте:</h3>
                                <p>Добраться до нас можно на метро. Также недалеко проходят маршруты некоторых
                                    автобусных и троллейбусных линий:</p>
                                <ul>
